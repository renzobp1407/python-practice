...
print(id(friends_last_seen)) #14334585786
...
print(id(friends_last_seen)) #14334586758
...
my_int.__add__(self, 1): return self.value += 1

my_int.__iadd__(self, 1) # the iadd makes an object inmutable

is mutable when you create a new object
