...
# Loading and extracting the data is called scraping
# Scraping is the act of leading a page using python or any programming language and extracting data from ot
# practice page https://books.toscrape.com/
