...
# Any retorna true si uno de los elementos en la lista es True, es decir, si los demas son falsos pero uno es true, entonces si devuelve True

# All retorna True solamente si todos los elementos en la lista o comparación son verdad 